...
String query = "select * from gentsuniform";
...
<div style="display: flex; justify-content: center;">
	...
	<h5 align="center">O/O THE RED(ER)#UNIFORM MATERIALS FOR MALE OFFICIAL(FOR 3
		YEARS)</h5>
...
<% while(rs.next()){ %>
	...
	<table>
		...
		<tr>
			...
			<td style="color: black; font-family: sans-serif; font-weight: bold;">V_Serial No.</td>
			<td style="color: blue; font-family: sans-serif; font-weight: bold;"><%=rs.getString(8) %> </td>
			
			<td><a href="ViewGentsVoucher.jsp?serialno=<%=rs.getString("serialno")%>">View Save Data </a></td>
		</tr>
