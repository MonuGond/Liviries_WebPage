...
<%
		...
		String date = request.getAttribute("issue_date").toString();
		System.out.println(p);
		System.out.println("date aa nhi rha..............................");
		LocationOtherAirport1Pozo l = (LocationOtherAirport1Pozo) request.getAttribute("LocationOtherAirport1Pozo");
...
<a href="Home.html">Home</a>
		...
		<table border="1">
			...
			<tr>
				<td>No.of pcs(32 Size): <%=p2.getH1_32_size()%></td>
				<td>: <%=p2.getP1_32_size()%></td>
				<td>: <%=p2.getF1_32_size()%></td>
				<td>: <%=p2.getLc1_32_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_32_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(34 Size ): <%=p2.getH2_34_size()%></td>
				<td>: <%=p2.getP2_34_size()%></td>
				<td>: <%=p2.getF2_34_size()%></td>
				<td>: <%=p2.getLc2_34_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_34_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(36 Size): <%=p2.getH3_36_size()%></td>
				<td>: <%=p2.getP3_36_size()%>
				</td>
				<td>: <%=p2.getF3_36_size()%>
				</td>
				<td>: <%=p2.getLc3_36_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_36_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(38 Size): <%=p2.getH4_38_size()%></td>
				<td>: <%=p2.getP4_38_size()%></td>
				<td>: <%=p2.getF4_38_size()%></td>
				<td>: <%=p2.getLc4_38_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_38_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(40 Size): <%=p2.getH5_40_size()%></td>
				<td>: <%=p2.getP5_40_size()%></td>
				<td>: <%=p2.getF5_40_size()%></td>
				<td>: <%=p2.getLc5_40_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_40_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(42 Size): <%=p2.getH6_42_size()%></td>
				<td>: <%=p2.getP6_42_size()%></td>
				<td>: <%=p2.getF6_42_size()%></td>
				<td>: <%=p2.getLc6_42_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_42_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(44 Size): <%=p2.getH7_44_size()%></td>
				<td>: <%=p2.getP7_44_size()%></td>
				<td>: <%=p2.getF7_44_size()%></td>
				<td>: <%=p2.getLc7_44_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_44_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(46 Size):<%=p2.getH8_46_size()%></td>
				<td>: <%=p2.getP8_46_size()%></td>
				<td>: <%=p2.getF8_46_size()%></td>
				<td>: <%=p2.getLc8_46_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_46_size()%></td>
			</tr>
			<tr>
				<td>No.of pcs(48 Size): <%=p2.getH9_48_size()%></td>
				<td>: <%=p2.getP9_48_size()%></td>
				<td>: <%=p2.getF9_48_size()%></td>
				<td>: <%=p2.getLc9_48_size()%></td>
				<td></td>
				<td>: <%=p2.getRemarks_48_size()%></td>
			</tr>
			<tr>
				<td>Total:<%=p2.getTotal_h_s_g_c_qtny()%></td>
				<td>: <%=p2.getTotal_p_o_qtny()%></td>
				<td>: <%=p2.getTotal_f_p_o_qtny()%></td>
				<td>: <%=p2.getTotal_l_c_qtny()%></td>
				<td></td>
				<td>: <%=p2.getTotal_remarks()%></td>
			</tr>

		</table>
		<form action="ReceiptOtherAirportPdfServlet" method="post">
		<h4 align="center">
		
		<input name="airportname" id="airportname" value=<%=l.getAirportname() %> readonly>
		<input name="issue_vr_no" id="issue_vr_no" value=<%=p.getIssue_vr_no() %> readonly>
			 <input type="submit" value="View PDF" name="btnview">
			 </h4>
		</form>

		<h4 align="center">
			<a href="Email.jsp">Email Send</a>
		</h4>
