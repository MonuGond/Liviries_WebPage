...
/**
 * Servlet implementation class UpdatePackingVoucherServlet
 */
public class UpdatePackingVoucherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePackingVoucherServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(date + "here.... ");
		/*
		 * SimpleDateFormat pdate1 = new SimpleDateFormat("dd-MM-yyyy"); try {
		 * java.util.Date pdate2 = pdate1.parse(pdate); } catch (ParseException e) { //
		...
		int i = 0;
		try {
			i = r2Dao.UpdatePackingVoucher1and2(p, p2);
			if (i == 1) {
