...
/**
 * Servlet implementation class UpdateLadiesUniformServlet
 */
public class UpdateLadiesUniformServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateLadiesUniformServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("Ladies Uniform Update Page Servlet.............................1");
		...
		try {
			int rs = d.LadiesUniformUpdate(p);
			if(rs==1) {
