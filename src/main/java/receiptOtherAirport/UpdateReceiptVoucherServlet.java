...
/**
 * Servlet implementation class UpdateReceiptVoucherServlet
 */
public class UpdateReceiptVoucherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateReceiptVoucherServlet() {
        super();
	...
	/*	int h10_50_size = 0;
		...
		int i = 0;
		try {
			i = r2Dao.UpdateReceiptOtherAirport2and1(r1, p2);
			if (i == 1) {
